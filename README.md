...
Integrates best-practice tools for comprehensive QC, peak calling, and differential accessibility analysis, providing insights into chromatin accessibility, chromatin states, and differences in accessibility between samples.
