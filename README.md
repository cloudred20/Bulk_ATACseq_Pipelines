...
#### (1) Pre-alignment processing and QC: 
  * Assess sequencing quality, adapter contamination, and duplication levels using **FastQC 0.12.1**. 
  * Remove adapter sequences and low-quality bases from paired-end reads using **Trim Galore 0.6.10**. 
  * Map trimmed reads to the reference genome (GRCh38.p13) using **Bowtie2 2 2.4.5** 
